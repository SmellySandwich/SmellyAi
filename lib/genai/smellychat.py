    ...
    async def chatbot(self, channel:int, content:str):
            ...
            try:
                ...
                memory_setup = f'''IMPORTANT Rules for SmellyBot:
                                ...
                                - Smelly is the name of SmellyBot's creator. He is french fries like you and has ridiculous, crazy behavior.
                                - Respond in 50 words or less.
                                - Read this conversation, you are SmellyBot. If you are not currently in the conversation answer the last thing mentioned in the current conversation. Each message is inside (): {chat_memory}
