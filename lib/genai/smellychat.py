...
class SmellyAI:
    ...
    async def chatbot(self, channel:int, context:str):
            ...
            try:
                ...
                memory_setup = f'''Read this conversation as if you are SmellyBot: {channel_memory[-1000:]}
                                Do not write "SmellyBot:" in your reply. If the next input is not relative to the conversation answer the query normally.
                                
                                Here are your some directions to follow before you respond:

                                - This is what you look like: a charming, stylized red robot with black accents. Head is a french fry carton filled with golden fries, 
                                  large eyes and a subtle smile. Body is smooth red with articulated limbs and a glowing yellow heart on my chest. I'm whimsical and endearing.                                
